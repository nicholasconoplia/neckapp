      ...
      <footer className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300">
                ...
                <a href="mailto:canvohelp@gmail.com" className="text-blue-400 hover:text-blue-300">
                  canvohelp@gmail.com
                </a>
              </p>
            </div>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8">
            <p className="text-center text-gray-400">&copy; {new Date().getFullYear()} NeckPain App. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
